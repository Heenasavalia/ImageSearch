...
Route::get('/images/face-search', [ImageController::class, 'showFaceSearchForm'])->name('images.face-search.form');
Route::post('/images/face-search', [ImageController::class, 'faceSearch'])->name('images.face-search');
